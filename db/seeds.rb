...
def seed_categories
  ...
  study = ['Arts and Humanities', 'Physical Science and Engineering', 'Math and Logid', 'Computer Science', 'Data Science', 'Economics and Finance', 'Business', 'Social Sciences', 'Language', 'Other']
